...
namespace GitHub.Authorizations.Clients.Item
{
    ...
    public partial class WithClient_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.Authorizations.Clients.Item.Item.WithFingerprintItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("fingerprint", position);
                return new global::GitHub.Authorizations.Clients.Item.Item.WithFingerprintItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Authorizations.Clients.Item.WithClient_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/oauth-authorizations/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app" />
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Models.Authorization?> PutAsync(global::GitHub.Authorizations.Clients.Item.WithClient_PutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.Authorization> PutAsync(global::GitHub.Authorizations.Clients.Item.WithClient_PutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHub.Authorizations.Clients.Item.WithClient_PutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHub.Authorizations.Clients.Item.WithClient_PutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Authorizations.Clients.Item.WithClient_ItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Authorizations.Clients.Item.WithClient_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Authorizations.Clients.Item.WithClient_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
