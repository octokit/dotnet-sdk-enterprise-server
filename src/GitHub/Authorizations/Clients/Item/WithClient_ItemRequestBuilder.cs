...
namespace GitHub.Authorizations.Clients.Item
{
    ...
    public partial class WithClient_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/oauth-authorizations/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app" />
        /// </summary>
