...
namespace GitHub.Admin.PreReceiveEnvironments.Item.Downloads.Latest
{
    ...
    public partial class LatestRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/enterprise-admin/pre-receive-environments#get-the-download-status-for-a-pre-receive-environment" />
        /// </summary>
