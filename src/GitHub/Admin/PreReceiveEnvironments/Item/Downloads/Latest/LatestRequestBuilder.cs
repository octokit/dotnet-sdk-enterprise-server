...
namespace GitHub.Admin.PreReceiveEnvironments.Item.Downloads.Latest {
    ...
    public class LatestRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/enterprise-admin/pre-receive-environments#get-the-download-status-for-a-pre-receive-environment" />
        /// </summary>
...
#nullable enable
        public async Task<PreReceiveEnvironmentDownloadStatus?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PreReceiveEnvironmentDownloadStatus> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PreReceiveEnvironmentDownloadStatus>(requestInfo, PreReceiveEnvironmentDownloadStatus.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// In addition to seeing the download status at the &quot;[Get a pre-receive environment](#get-a-pre-receive-environment)&quot; endpoint, there is also this separate endpoint for just the download status.
        /// </summary>
