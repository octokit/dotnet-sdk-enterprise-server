...
namespace GitHub.Admin.PreReceiveEnvironments.Item.Downloads {
    ...
    public class DownloadsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/enterprise-admin/pre-receive-environments#start-a-pre-receive-environment-download" />
        /// </summary>
        /// <returns>A <see cref="PreReceiveEnvironmentDownloadStatus"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="PreReceiveEnvironmentDownloadStatus422Error">When receiving a 422 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PreReceiveEnvironmentDownloadStatus?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PreReceiveEnvironmentDownloadStatus> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                {"422", PreReceiveEnvironmentDownloadStatus422Error.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<PreReceiveEnvironmentDownloadStatus>(requestInfo, PreReceiveEnvironmentDownloadStatus.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Triggers a new download of the environment tarball from the environment&apos;s `image_url`. When the download is finished, the newly downloaded tarball will overwrite the existing environment.If a download cannot be triggered, you will receive a `422 Unprocessable Entity` response.The possible error messages are:* _Cannot modify or delete the default environment_* _Can not start a new download when a download is in progress_
        /// </summary>
