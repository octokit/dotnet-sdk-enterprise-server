...
namespace GitHub.Admin.Hooks.Item.Pings {
    ...
    public class PingsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// This will trigger a [ping event](https://docs.github.com/enterprise-server@3.12/webhooks/#ping-event) to be sent to the webhook.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/global-webhooks#ping-a-global-webhook" />
        /// </summary>
