...
namespace GitHub.Installation.Repositories
{
    ...
    public partial class RepositoriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/apps/installations#list-repositories-accessible-to-the-app-installation" />
        /// </summary>
