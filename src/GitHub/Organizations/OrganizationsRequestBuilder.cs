...
namespace GitHub.Organizations
{
    ...
    public partial class OrganizationsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Lists all organizations, in the order that they were created.&gt; [!NOTE]&gt; Pagination is powered exclusively by the `since` parameter. Use the [Link header](https://docs.github.com/enterprise-server@3.12/rest/guides/using-pagination-in-the-rest-api#using-link-headers) to get the URL for the next page of organizations.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/orgs#list-organizations" />
        /// </summary>
