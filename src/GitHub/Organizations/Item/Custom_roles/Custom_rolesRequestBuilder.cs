...
namespace GitHub.Organizations.Item.Custom_roles
{
    ...
    public partial class Custom_rolesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/custom-roles#closing-down---list-custom-repository-roles-in-an-organization" />
        /// </summary>
