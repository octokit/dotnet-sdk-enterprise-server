...
namespace GitHub.Teams.Item.Projects {
    ...
    public class ProjectsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team projects`](https://docs.github.com/enterprise-server@3.11/rest/teams/teams#list-team-projects) endpoint.Lists the organization projects for a team.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/teams/teams#list-team-projects-legacy" />
        /// </summary>
