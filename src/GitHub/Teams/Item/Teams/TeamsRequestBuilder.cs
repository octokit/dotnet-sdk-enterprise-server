...
namespace GitHub.Teams.Item.Teams {
    ...
    public class TeamsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// &gt; [!WARNING]&gt; **Deprecation notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List child teams`](https://docs.github.com/enterprise-server@3.10/rest/teams/teams#list-child-teams) endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/teams/teams#list-child-teams-legacy" />
        /// </summary>
