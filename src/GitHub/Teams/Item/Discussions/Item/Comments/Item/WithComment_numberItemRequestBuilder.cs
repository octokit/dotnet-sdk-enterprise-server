...
namespace GitHub.Teams.Item.Discussions.Item.Comments.Item
{
    ...
    public partial class WithComment_numberItemRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.Teams.Item.Discussions.Item.Comments.Item.Reactions.ReactionsRequestBuilder Reactions
        {
            get => new global::GitHub.Teams.Item.Discussions.Item.Comments.Item.Reactions.ReactionsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/teams/discussion-comments#delete-a-discussion-comment-legacy" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/teams/discussion-comments#get-a-discussion-comment-legacy" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.TeamDiscussionComment?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.TeamDiscussionComment> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/teams/discussion-comments#update-a-discussion-comment-legacy" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Models.TeamDiscussionComment"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.TeamDiscussionComment?> PatchAsync(global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.TeamDiscussionComment> PatchAsync(global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Teams.Item.Discussions.Item.Comments.Item.WithComment_numberItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
