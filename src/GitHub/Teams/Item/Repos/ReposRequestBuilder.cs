...
namespace GitHub.Teams.Item.Repos
{
    ...
    public partial class ReposRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// &gt; [!WARNING]&gt; **Endpoint closing down notice:** This endpoint route is closing down and will be removed from the Teams API. We recommend migrating your existing code to use the new [List team repositories](https://docs.github.com/enterprise-server@3.12/rest/teams/teams#list-team-repositories) endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/teams/teams#list-team-repositories-legacy" />
        /// </summary>
