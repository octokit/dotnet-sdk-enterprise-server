...
namespace GitHub.Search.Users
{
    ...
    public partial class UsersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/search/search#search-users" />
        /// </summary>
...
#nullable restore
            ...
            public string Q { get; set; }
#endif
            /// <summary>Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@3.14/rest/search/search#ranking-search-results)</summary>
            [QueryParameter("sort")]
