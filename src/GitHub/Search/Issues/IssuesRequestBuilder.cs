...
namespace GitHub.Search.Issues {
    ...
    public class IssuesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/search/search#search-issues-and-pull-requests" />
        /// </summary>
