...
namespace GitHub.Search.Code
{
    ...
    public partial class CodeRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/search/search#search-code" />
        /// </summary>
...
#nullable restore
            ...
            public string Q { get; set; }
#endif
            /// <summary>Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub Enterprise Server search infrastructure. Default: [best match](https://docs.github.com/enterprise-server@3.14/rest/search/search#ranking-search-results)</summary>
            [QueryParameter("sort")]
