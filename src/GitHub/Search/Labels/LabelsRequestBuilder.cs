...
namespace GitHub.Search.Labels {
    ...
    public class LabelsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/search/search#search-labels" />
        /// </summary>
...
#nullable restore
        ...
        public class LabelsRequestBuilderGetQueryParameters 
        {
            ...
            /// <summary>The search keywords. This endpoint does not accept qualifiers in the query. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/enterprise-server@3.13/rest/search/search#constructing-a-search-query).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("q")]
...
#nullable restore
            ...
            /// <summary>Sorts the results of your query by when the label was `created` or `updated`. Default: [best match](https://docs.github.com/enterprise-server@3.13/rest/search/search#ranking-search-results)</summary>
            [QueryParameter("sort")]
