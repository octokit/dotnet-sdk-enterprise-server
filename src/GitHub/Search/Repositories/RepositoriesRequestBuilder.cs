...
namespace GitHub.Search.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/search/search#search-repositories" />
        /// </summary>
...
#nullable restore
            ...
            public string Q { get; set; }
#endif
            /// <summary>Sorts the results of your query by number of `stars`, `forks`, or `help-wanted-issues` or how recently the items were `updated`. Default: [best match](https://docs.github.com/enterprise-server@3.12/rest/search/search#ranking-search-results)</summary>
            [QueryParameter("sort")]
