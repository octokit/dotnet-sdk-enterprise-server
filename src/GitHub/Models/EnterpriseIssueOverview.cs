...
namespace GitHub.Models {
    ...
    public class EnterpriseIssueOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseIssueOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseIssueOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseIssueOverview();
        }
        /// <summary>
