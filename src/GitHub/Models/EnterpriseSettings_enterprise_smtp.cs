...
namespace GitHub.Models {
    ...
    public class EnterpriseSettings_enterprise_smtp : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseSettings_enterprise_smtp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="EnterpriseSettings_enterprise_smtp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static EnterpriseSettings_enterprise_smtp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseSettings_enterprise_smtp();
        }
        /// <summary>
