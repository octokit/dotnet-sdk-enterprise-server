...
namespace GitHub.Models {
    ...
    /// Organization Full
    /// </summary>
    public class OrganizationFull : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public string DefaultRepositoryPermission { get; set; }
#endif
        /// <summary>Whether Dependabot alerts are automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
        public bool? DependabotAlertsEnabledForNewRepositories { get; set; }
        /// <summary>Whether Dependabot security updates are automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
        public bool? DependabotSecurityUpdatesEnabledForNewRepositories { get; set; }
        /// <summary>Whether dependency graph is automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OrganizationFull_plan? Plan { get; set; }
#nullable restore
#else
        public OrganizationFull_plan Plan { get; set; }
#endif
...
#nullable restore
        ...
        public string ReposUrl { get; set; }
#endif
        /// <summary>Whether secret scanning is automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
...
#nullable restore
        ...
        /// <summary>Whether secret scanning push protection is automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="OrganizationFull"/> and sets the default values.
        /// </summary>
        ...
        public static OrganizationFull CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"plan", n => { Plan = n.GetObjectValue<OrganizationFull_plan>(OrganizationFull_plan.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<OrganizationFull_plan>("plan", Plan);
