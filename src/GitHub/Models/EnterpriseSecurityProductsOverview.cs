...
namespace GitHub.Models {
    ...
    public class EnterpriseSecurityProductsOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseSecurityProductsOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseSecurityProductsOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseSecurityProductsOverview();
        }
        /// <summary>
