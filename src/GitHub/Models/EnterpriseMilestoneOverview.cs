...
namespace GitHub.Models {
    ...
    public class EnterpriseMilestoneOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseMilestoneOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseMilestoneOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseMilestoneOverview();
        }
        /// <summary>
