...
namespace GitHub.Models {
    ...
    public class EnterpriseGistOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseGistOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseGistOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseGistOverview();
        }
        /// <summary>
