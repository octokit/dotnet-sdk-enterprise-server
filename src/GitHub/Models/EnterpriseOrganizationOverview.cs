...
namespace GitHub.Models {
    ...
    public class EnterpriseOrganizationOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseOrganizationOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseOrganizationOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseOrganizationOverview();
        }
        /// <summary>
