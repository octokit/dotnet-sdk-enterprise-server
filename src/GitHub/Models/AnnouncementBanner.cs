...
namespace GitHub.Models {
    ...
    /// </summary>
    public class AnnouncementBanner : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="AnnouncementBanner"/> and sets the default values.
        /// </summary>
        ...
        public static AnnouncementBanner CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AnnouncementBanner();
        }
        /// <summary>
