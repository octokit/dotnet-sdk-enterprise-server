...
namespace GitHub.Models {
    ...
    public class EnterpriseSettings_enterprise_ldap : IAdditionalDataHolder, IParsable 
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EnterpriseSettings_enterprise_ldap_profile? Profile { get; set; }
#nullable restore
#else
        public EnterpriseSettings_enterprise_ldap_profile Profile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public EnterpriseSettings_enterprise_ldap_reconciliation? Reconciliation { get; set; }
#nullable restore
#else
        public EnterpriseSettings_enterprise_ldap_reconciliation Reconciliation { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseSettings_enterprise_ldap"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="EnterpriseSettings_enterprise_ldap"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static EnterpriseSettings_enterprise_ldap CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseSettings_enterprise_ldap();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"profile", n => { Profile = n.GetObjectValue<EnterpriseSettings_enterprise_ldap_profile>(EnterpriseSettings_enterprise_ldap_profile.CreateFromDiscriminatorValue); } },
                {"reconciliation", n => { Reconciliation = n.GetObjectValue<EnterpriseSettings_enterprise_ldap_reconciliation>(EnterpriseSettings_enterprise_ldap_reconciliation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<EnterpriseSettings_enterprise_ldap_profile>("profile", Profile);
            writer.WriteObjectValue<EnterpriseSettings_enterprise_ldap_reconciliation>("reconciliation", Reconciliation);
