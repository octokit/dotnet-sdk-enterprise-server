...
namespace GitHub.Models {
    ...
    public class EnterpriseUserOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseUserOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseUserOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseUserOverview();
        }
        /// <summary>
