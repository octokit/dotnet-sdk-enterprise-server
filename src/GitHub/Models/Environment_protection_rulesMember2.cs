...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Environment_protection_rulesMember2_reviewers>? Reviewers { get; set; }
#nullable restore
#else
        public List<Environment_protection_rulesMember2_reviewers> Reviewers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Environment_protection_rulesMember2"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Environment_protection_rulesMember2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Environment_protection_rulesMember2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Environment_protection_rulesMember2();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Environment_protection_rulesMember2_reviewers>("reviewers", Reviewers);
