...
namespace GitHub.Models {
    ...
    /// Ldap Private User
    /// </summary>
    public class LdapMappingUser : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public LdapMappingUser_plan? Plan { get; set; }
#nullable restore
#else
        public LdapMappingUser_plan Plan { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="LdapMappingUser"/> and sets the default values.
        /// </summary>
        ...
        public static LdapMappingUser CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new LdapMappingUser();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"plan", n => { Plan = n.GetObjectValue<LdapMappingUser_plan>(LdapMappingUser_plan.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<LdapMappingUser_plan>("plan", Plan);
