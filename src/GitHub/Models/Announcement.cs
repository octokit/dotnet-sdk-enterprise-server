...
namespace GitHub.Models {
    ...
    /// </summary>
    public class Announcement : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="Announcement"/> and sets the default values.
        /// </summary>
        public Announcement()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Announcement"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Announcement CreateFromDiscriminatorValue(IParseNode parseNode)
        {
