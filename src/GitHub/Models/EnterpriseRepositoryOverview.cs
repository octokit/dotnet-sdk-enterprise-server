...
namespace GitHub.Models {
    ...
    public class EnterpriseRepositoryOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseRepositoryOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseRepositoryOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseRepositoryOverview();
        }
        /// <summary>
