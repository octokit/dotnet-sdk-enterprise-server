...
namespace GitHub.Models
{
    ...
    public partial class GhesGetSettings_ldap : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.GhesGetSettings_ldap_profile? Profile { get; set; }
#nullable restore
#else
        public global::GitHub.Models.GhesGetSettings_ldap_profile Profile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Models.GhesGetSettings_ldap_reconciliation? Reconciliation { get; set; }
#nullable restore
#else
        public global::GitHub.Models.GhesGetSettings_ldap_reconciliation Reconciliation { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Models.GhesGetSettings_ldap"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Models.GhesGetSettings_ldap"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Models.GhesGetSettings_ldap CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Models.GhesGetSettings_ldap();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "base", n => { Base = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "profile", n => { Profile = n.GetObjectValue<global::GitHub.Models.GhesGetSettings_ldap_profile>(global::GitHub.Models.GhesGetSettings_ldap_profile.CreateFromDiscriminatorValue); } },
                { "reconciliation", n => { Reconciliation = n.GetObjectValue<global::GitHub.Models.GhesGetSettings_ldap_reconciliation>(global::GitHub.Models.GhesGetSettings_ldap_reconciliation.CreateFromDiscriminatorValue); } },
                ...
                { "user_groups", n => { UserGroups = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Models.GhesGetSettings_ldap_profile>("profile", Profile);
            writer.WriteObjectValue<global::GitHub.Models.GhesGetSettings_ldap_reconciliation>("reconciliation", Reconciliation);
