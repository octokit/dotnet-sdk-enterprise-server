...
namespace GitHub.Models {
    ...
    public class EnterpriseCommentOverview : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="EnterpriseCommentOverview"/> and sets the default values.
        /// </summary>
        ...
        public static EnterpriseCommentOverview CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EnterpriseCommentOverview();
        }
        /// <summary>
