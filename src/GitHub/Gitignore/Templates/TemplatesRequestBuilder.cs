...
namespace GitHub.Gitignore.Templates
{
    ...
    public partial class TemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Gitignore.Templates.Item.WithNameItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Gitignore.Templates.TemplatesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <summary>
        /// List all templates available to pass as an option when [creating a repository](https://docs.github.com/enterprise-server@3.13/rest/repos/repos#create-a-repository-for-the-authenticated-user).
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/gitignore/gitignore#get-all-gitignore-templates" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Gitignore.Templates.TemplatesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Gitignore.Templates.TemplatesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Gitignore.Templates.TemplatesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
