...
namespace GitHub.Gitignore.Templates
{
    ...
    public partial class TemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// List all templates available to pass as an option when [creating a repository](https://docs.github.com/enterprise-server@3.12/rest/repos/repos#create-a-repository-for-the-authenticated-user).
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/gitignore/gitignore#get-all-gitignore-templates" />
        /// </summary>
