...
namespace GitHub.Enterprises.Item.Actions.Permissions {
    ...
    public class PermissionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/actions/permissions#get-github-actions-permissions-for-an-enterprise" />
        /// </summary>
...
#nullable enable
        public async Task<ActionsEnterprisePermissions?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ActionsEnterprisePermissions> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ActionsEnterprisePermissions>(requestInfo, ActionsEnterprisePermissions.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/actions/permissions#set-github-actions-permissions-for-an-enterprise" />
        /// </summary>
