...
namespace GitHub.Enterprises.Item.Actions.Runners
{
    ...
    public partial class RunnersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/actions/self-hosted-runners#list-self-hosted-runners-for-an-enterprise" />
        /// </summary>
