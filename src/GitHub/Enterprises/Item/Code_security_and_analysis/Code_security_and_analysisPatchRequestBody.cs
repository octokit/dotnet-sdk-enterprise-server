...
namespace GitHub.Enterprises.Item.Code_security_and_analysis {
    ...
    public class Code_security_and_analysisPatchRequestBody : IAdditionalDataHolder, IParsable 
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Whether GitHub Advanced Security is automatically enabled for new repositories. For more information, see &quot;[About GitHub Advanced Security](https://docs.github.com/enterprise-server@3.12/get-started/learning-about-github/about-github-advanced-security).&quot;</summary>
        public bool? AdvancedSecurityEnabledForNewRepositories { get; set; }
        /// <summary>Whether Dependabot alerts are automatically enabled for new repositories. For more information, see &quot;[About Dependabot alerts](https://docs.github.com/enterprise-server@3.12/code-security/dependabot/dependabot-alerts/about-dependabot-alerts).&quot;</summary>
        public bool? DependabotAlertsEnabledForNewRepositories { get; set; }
        /// <summary>Whether secret scanning is automatically enabled for new repositories. For more information, see &quot;[About secret scanning](https://docs.github.com/enterprise-server@3.12/code-security/secret-scanning/about-secret-scanning).&quot;</summary>
...
#nullable restore
        ...
        public string SecretScanningPushProtectionCustomLink { get; set; }
#endif
        /// <summary>Whether secret scanning push protection is automatically enabled for new repositories. For more information, see &quot;[Protecting pushes with secret scanning](https://docs.github.com/enterprise-server@3.12/code-security/secret-scanning/protecting-pushes-with-secret-scanning).&quot;</summary>
        public bool? SecretScanningPushProtectionEnabledForNewRepositories { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="Code_security_and_analysisPatchRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Code_security_and_analysisPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Code_security_and_analysisPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Code_security_and_analysisPatchRequestBody();
        }
        /// <summary>
