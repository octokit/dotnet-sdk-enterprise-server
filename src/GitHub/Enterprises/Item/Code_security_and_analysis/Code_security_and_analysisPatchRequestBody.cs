...
namespace GitHub.Enterprises.Item.Code_security_and_analysis {
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Whether GitHub Advanced Security is automatically enabled for new repositories. For more information, see &quot;[About GitHub Advanced Security](https://docs.github.com/enterprise-server@3.11/get-started/learning-about-github/about-github-advanced-security).&quot;</summary>
        public bool? AdvancedSecurityEnabledForNewRepositories { get; set; }
        /// <summary>Whether Dependabot alerts are automatically enabled for new repositories. For more information, see &quot;[About Dependabot alerts](https://docs.github.com/enterprise-server@3.11/code-security/dependabot/dependabot-alerts/about-dependabot-alerts).&quot;</summary>
        public bool? DependabotAlertsEnabledForNewRepositories { get; set; }
        /// <summary>Whether secret scanning is automatically enabled for new repositories. For more information, see &quot;[About secret scanning](https://docs.github.com/enterprise-server@3.11/code-security/secret-scanning/about-secret-scanning).&quot;</summary>
...
#nullable restore
        ...
        public string SecretScanningPushProtectionCustomLink { get; set; }
#endif
        /// <summary>Whether secret scanning push protection is automatically enabled for new repositories. For more information, see &quot;[Protecting pushes with secret scanning](https://docs.github.com/enterprise-server@3.11/code-security/secret-scanning/protecting-pushes-with-secret-scanning).&quot;</summary>
