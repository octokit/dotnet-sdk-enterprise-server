...
using GitHub.Notifications.Threads.Item;
...
namespace GitHub.Notifications.Threads
{
    ...
    public partial class ThreadsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="position">The unique identifier of the notification thread. This corresponds to the value returned in the `id` field when you retrieve notifications (for example with the [`GET /notifications` operation](https://docs.github.com/enterprise-server@3.14/rest/activity/notifications#list-notifications-for-the-authenticated-user)).</param>
        /// <returns>A <see cref="global::GitHub.Notifications.Threads.Item.WithThread_ItemRequestBuilder"/></returns>
        public global::GitHub.Notifications.Threads.Item.WithThread_ItemRequestBuilder this[int position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Notifications.Threads.ThreadsRequestBuilder"/> and sets the default values.
        /// </summary>
