...
namespace GitHub.Repos.Item.Item.Collaborators.Item
{
    ...
    public partial class WithUsernameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/collaborators/collaborators#remove-a-repository-collaborator" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/collaborators/collaborators#check-if-a-user-is-a-repository-collaborator" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/collaborators/collaborators#add-a-repository-collaborator" />
        /// </summary>
