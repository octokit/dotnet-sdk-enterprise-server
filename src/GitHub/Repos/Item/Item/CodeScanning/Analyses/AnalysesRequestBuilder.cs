...
namespace GitHub.Repos.Item.Item.CodeScanning.Analyses {
    ...
    public class AnalysesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/code-scanning/code-scanning#list-code-scanning-analyses-for-a-repository" />
        /// </summary>
        /// <returns>A List&lt;CodeScanningAnalysis&gt;</returns>
