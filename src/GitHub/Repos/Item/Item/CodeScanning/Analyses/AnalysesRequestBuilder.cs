...
namespace GitHub.Repos.Item.Item.CodeScanning.Analyses {
    ...
    public class AnalysesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/code-scanning/code-scanning#list-code-scanning-analyses-for-a-repository" />
        /// </summary>
