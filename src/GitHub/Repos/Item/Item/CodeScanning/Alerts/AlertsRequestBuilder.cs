...
namespace GitHub.Repos.Item.Item.CodeScanning.Alerts {
    ...
    public class AlertsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/code-scanning/code-scanning#list-code-scanning-alerts-for-a-repository" />
        /// </summary>
