...
namespace GitHub.Repos.Item.Item.Statuses.Item {
    ...
    public class WithShaItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/commits/statuses#create-a-commit-status" />
        /// </summary>
        /// <returns>A <see cref="GitHub.Models.Status"/></returns>
