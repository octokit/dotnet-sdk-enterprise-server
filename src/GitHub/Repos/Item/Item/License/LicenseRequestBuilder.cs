...
namespace GitHub.Repos.Item.Item.License
{
    ...
    public partial class LicenseRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/licenses/licenses#get-the-license-for-a-repository" />
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Models.LicenseContent?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.LicenseContent> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
