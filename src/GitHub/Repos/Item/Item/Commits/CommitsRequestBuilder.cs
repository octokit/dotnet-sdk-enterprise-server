...
namespace GitHub.Repos.Item.Item.Commits {
    ...
    public class CommitsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public Commit_shaItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("commit_sha%2Did", position);
                return new Commit_shaItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/commits/commits#list-commits" />
        /// </summary>
