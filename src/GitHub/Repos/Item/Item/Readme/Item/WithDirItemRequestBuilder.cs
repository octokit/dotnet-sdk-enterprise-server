...
namespace GitHub.Repos.Item.Item.Readme.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/repos/contents#get-a-repository-readme-for-a-directory" />
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Models.ContentFile?> GetAsync(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder.WithDirItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.ContentFile> GetAsync(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder.WithDirItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder.WithDirItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder.WithDirItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Repos.Item.Item.Readme.Item.WithDirItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets the README from a repository directory.This endpoint supports the following custom media types. For more information, see &quot;[Media types](https://docs.github.com/enterprise-server@3.12/rest/using-the-rest-api/getting-started-with-the-rest-api#media-types).&quot;- **`application/vnd.github.raw+json`**: Returns the raw file contents. This is the default if you do not specify a media type.- **`application/vnd.github.html+json`**: Returns the README in HTML. Markup languages are rendered to HTML using GitHub&apos;s open-source [Markup library](https://github.com/github/markup).
        /// </summary>
