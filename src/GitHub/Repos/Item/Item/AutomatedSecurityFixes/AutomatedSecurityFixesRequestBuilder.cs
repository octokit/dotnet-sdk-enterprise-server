...
namespace GitHub.Repos.Item.Item.AutomatedSecurityFixes {
    ...
    public class AutomatedSecurityFixesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/repos/repos#check-if-automated-security-fixes-are-enabled-for-a-repository" />
        /// </summary>
