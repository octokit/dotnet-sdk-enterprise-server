...
namespace GitHub.Repos.Item.Item.AutomatedSecurityFixes
{
    ...
    public partial class AutomatedSecurityFixesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/repos/repos#check-if-dependabot-security-updates-are-enabled-for-a-repository" />
        /// </summary>
