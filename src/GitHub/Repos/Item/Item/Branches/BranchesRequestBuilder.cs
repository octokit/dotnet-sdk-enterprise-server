...
namespace GitHub.Repos.Item.Item.Branches {
    ...
    public class BranchesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <param name="position">The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.10/graphql).</param>
        ...
        /// <summary>
        /// List branches
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/branches/branches#list-branches" />
        /// </summary>
