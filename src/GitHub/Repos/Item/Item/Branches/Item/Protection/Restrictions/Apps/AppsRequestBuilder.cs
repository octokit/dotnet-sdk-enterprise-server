...
namespace GitHub.Repos.Item.Item.Branches.Item.Protection.Restrictions.Apps
{
    ...
    public partial class AppsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/branches/branch-protection#remove-app-access-restrictions" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/branches/branch-protection#get-apps-with-access-to-the-protected-branch" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.Models.Integration&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/branches/branch-protection#add-app-access-restrictions" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.Models.Integration&gt;</returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/branches/branch-protection#set-app-access-restrictions" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.Models.Integration&gt;</returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
