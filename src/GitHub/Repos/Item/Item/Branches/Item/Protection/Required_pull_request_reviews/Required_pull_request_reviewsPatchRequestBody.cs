...
#nullable enable
        public Required_pull_request_reviewsPatchRequestBody_bypass_pull_request_allowances? BypassPullRequestAllowances { get; set; }
#nullable restore
#else
        public Required_pull_request_reviewsPatchRequestBody_bypass_pull_request_allowances BypassPullRequestAllowances { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Required_pull_request_reviewsPatchRequestBody_dismissal_restrictions? DismissalRestrictions { get; set; }
#nullable restore
#else
        public Required_pull_request_reviewsPatchRequestBody_dismissal_restrictions DismissalRestrictions { get; set; }
#endif
        ...
        /// <summary>Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.11/articles/about-code-owners/) have reviewed.</summary>
