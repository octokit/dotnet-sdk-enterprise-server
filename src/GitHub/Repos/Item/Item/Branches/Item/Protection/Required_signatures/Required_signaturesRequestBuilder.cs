...
namespace GitHub.Repos.Item.Item.Branches.Item.Protection.Required_signatures {
    ...
    public class Required_signaturesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/branches/branch-protection#delete-commit-signature-protection" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/branches/branch-protection#get-commit-signature-protection" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/branches/branch-protection#create-commit-signature-protection" />
        /// </summary>
        /// <returns>A <see cref="ProtectedBranchAdminEnforced"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
