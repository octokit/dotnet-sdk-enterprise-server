...
namespace GitHub.Repos.Item.Item.SecretScanning.Alerts.Item {
    ...
    public class WithAlert_numberItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new LocationsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/secret-scanning/secret-scanning#get-a-secret-scanning-alert" />
        /// </summary>
        /// <returns>A <see cref="SecretScanningAlert"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="SecretScanningAlert503Error">When receiving a 503 status code</exception>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/secret-scanning/secret-scanning#update-a-secret-scanning-alert" />
        /// </summary>
        /// <returns>A <see cref="SecretScanningAlert"/></returns>
