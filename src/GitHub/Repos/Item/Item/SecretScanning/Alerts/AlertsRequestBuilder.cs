...
namespace GitHub.Repos.Item.Item.SecretScanning.Alerts
{
    ...
    public partial class AlertsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/secret-scanning/secret-scanning#list-secret-scanning-alerts-for-a-repository" />
        /// </summary>
