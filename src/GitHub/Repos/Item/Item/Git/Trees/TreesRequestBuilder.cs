...
namespace GitHub.Repos.Item.Item.Git.Trees {
    ...
    public class TreesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WithTree_shaItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/git/trees#create-a-tree" />
        /// </summary>
