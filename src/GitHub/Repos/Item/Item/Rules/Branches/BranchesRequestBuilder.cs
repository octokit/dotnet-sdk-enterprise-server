...
namespace GitHub.Repos.Item.Item.Rules.Branches
{
    ...
    public partial class BranchesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="position">The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.12/graphql).</param>
