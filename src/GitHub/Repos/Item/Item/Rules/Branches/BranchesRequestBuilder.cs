...
namespace GitHub.Repos.Item.Item.Rules.Branches
{
    ...
    public partial class BranchesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="position">The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.11/graphql).</param>
        /// <returns>A <see cref="global::GitHub.Repos.Item.Item.Rules.Branches.Item.WithBranchItemRequestBuilder"/></returns>
        public global::GitHub.Repos.Item.Item.Rules.Branches.Item.WithBranchItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("branch", position);
                return new global::GitHub.Repos.Item.Item.Rules.Branches.Item.WithBranchItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Repos.Item.Item.Rules.Branches.BranchesRequestBuilder"/> and sets the default values.
        /// </summary>
