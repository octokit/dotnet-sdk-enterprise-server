...
namespace GitHub.Repos.Item.Item.Deployments.Item
{
    ...
    public partial class WithDeployment_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Repos.Item.Item.Deployments.Item.Statuses.StatusesRequestBuilder Statuses
        {
            get => new global::GitHub.Repos.Item.Item.Deployments.Item.Statuses.StatusesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/deployments/deployments#delete-a-deployment" />
        /// </summary>
...
#nullable restore
        ...
        /// <summary>
        /// Get a deployment
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/deployments/deployments#get-a-deployment" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.Deployment?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.Deployment> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
