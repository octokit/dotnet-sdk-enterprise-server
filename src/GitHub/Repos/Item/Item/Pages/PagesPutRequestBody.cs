...
namespace GitHub.Repos.Item.Item.Pages
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Specify a custom domain for the repository. Sending a `null` value will remove the custom domain. For more about custom domains, see &quot;[Using a custom domain with GitHub Pages](https://docs.github.com/enterprise-server@3.11/pages/configuring-a-custom-domain-for-your-github-pages-site).&quot;</summary>
