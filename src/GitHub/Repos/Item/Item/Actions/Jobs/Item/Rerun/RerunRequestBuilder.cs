...
namespace GitHub.Repos.Item.Item.Actions.Jobs.Item.Rerun {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="RerunRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/actions/workflow-runs#re-run-a-job-from-a-workflow-run" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RerunRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
