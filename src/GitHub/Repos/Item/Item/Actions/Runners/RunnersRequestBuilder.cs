...
namespace GitHub.Repos.Item.Item.Actions.Runners
{
    ...
    public partial class RunnersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/actions/self-hosted-runners#list-self-hosted-runners-for-a-repository" />
        /// </summary>
