...
namespace GitHub.Repos.Item.Item.Actions.Runners.Item.Labels.Item
{
    ...
    public partial class WithNameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/actions/self-hosted-runners#remove-a-custom-label-from-a-self-hosted-runner-for-a-repository" />
        /// </summary>
