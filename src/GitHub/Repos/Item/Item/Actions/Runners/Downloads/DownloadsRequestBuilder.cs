...
namespace GitHub.Repos.Item.Item.Actions.Runners.Downloads {
    ...
    public class DownloadsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/actions/self-hosted-runners#list-runner-applications-for-a-repository" />
        /// </summary>
