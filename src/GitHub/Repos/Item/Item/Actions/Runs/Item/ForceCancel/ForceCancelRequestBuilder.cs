...
namespace GitHub.Repos.Item.Item.Actions.Runs.Item.ForceCancel {
    ...
    public class ForceCancelRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/actions/workflow-runs#force-cancel-a-workflow-run" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ForceCancelRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
