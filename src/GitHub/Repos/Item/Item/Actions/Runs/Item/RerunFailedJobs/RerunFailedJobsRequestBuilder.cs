...
namespace GitHub.Repos.Item.Item.Actions.Runs.Item.RerunFailedJobs {
    ...
    public class RerunFailedJobsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/actions/workflow-runs#re-run-failed-jobs-from-a-workflow-run" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RerunFailedJobsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
