...
namespace GitHub.Repos.Item.Item.Actions.Runs.Item.Deployment_protection_rule {
    ...
    public class Deployment_protection_ruleRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/actions/workflow-runs#review-custom-deployment-protection-rules-for-a-workflow-run" />
        /// </summary>
...
#nullable restore
            ...
            public static Deployment_protection_rulePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                ...
                result.DeploymentProtectionRulePostRequestBodyReviewCustomGatesStateRequired = new GitHub.Models.ReviewCustomGatesStateRequired();
                result.ReviewCustomGatesCommentRequired = new GitHub.Models.ReviewCustomGatesCommentRequired();
                result.ReviewCustomGatesStateRequired = new GitHub.Models.ReviewCustomGatesStateRequired();
                return result;
            }
            /// <summary>
