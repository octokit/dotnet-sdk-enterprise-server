...
namespace GitHub.Repos.Item.Item.Actions.Workflows.Item.Runs
{
    ...
    public partial class RunsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/actions/workflow-runs#list-workflow-runs-for-a-workflow" />
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Returns workflow runs created within the given date-time range. For more information on the syntax, see &quot;[Understanding the search syntax](https://docs.github.com/enterprise-server@3.14/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates).&quot;</summary>
            [QueryParameter("created")]
            public DateTimeOffset? Created { get; set; }
            /// <summary>Returns workflow run triggered by the event you specify. For example, `push`, `pull_request` or `issue`. For more information, see &quot;[Events that trigger workflows](https://docs.github.com/enterprise-server@3.14/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows).&quot;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
