...
namespace GitHub.Repos.Item.Item.Actions.Caches {
    ...
    public class CachesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/actions/cache#delete-github-actions-caches-for-a-repository-using-a-cache-key" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/actions/cache#list-github-actions-caches-for-a-repository" />
        /// </summary>
        /// <returns>A <see cref="ActionsCacheList"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
