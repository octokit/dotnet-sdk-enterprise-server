...
namespace GitHub.Repos.Item.Item.PreReceiveHooks {
    ...
    public class PreReceiveHooksRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/enterprise-admin/repo-pre-receive-hooks#list-pre-receive-hooks-for-a-repository" />
        /// </summary>
