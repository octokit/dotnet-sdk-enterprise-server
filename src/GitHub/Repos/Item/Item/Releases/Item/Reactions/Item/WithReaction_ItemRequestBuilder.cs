...
namespace GitHub.Repos.Item.Item.Releases.Item.Reactions.Item
{
    ...
    public partial class WithReaction_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// &gt; [!NOTE]&gt; You can also specify a repository by `repository_id` using the route `DELETE delete /repositories/:repository_id/releases/:release_id/reactions/:reaction_id`.Delete a reaction to a [release](https://docs.github.com/enterprise-server@3.14/rest/releases/releases#get-a-release).
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/reactions/reactions#delete-a-release-reaction" />
        /// </summary>
