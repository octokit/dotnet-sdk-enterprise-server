...
namespace GitHub.Repos.Item.Item.Releases.Item.Reactions {
    ...
    public class ReactionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// List the reactions to a [release](https://docs.github.com/enterprise-server@3.12/rest/releases/releases#get-a-release).
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#list-reactions-for-a-release" />
        /// </summary>
...
#nullable restore
        ...
        /// <summary>
        /// Create a reaction to a [release](https://docs.github.com/enterprise-server@3.12/rest/releases/releases#get-a-release). A response with a `Status: 200 OK` means that you already added the reaction type to this release.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#create-reaction-for-a-release" />
        /// </summary>
...
#nullable restore
        ...
        {
            /// <summary>Returns a single [reaction type](https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a release.</summary>
