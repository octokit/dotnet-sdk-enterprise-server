...
#nullable restore
        ...
        public WithRelease_PatchRequestBody_make_latest? MakeLatest { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="WithRelease_PatchRequestBody"/> and sets the default values.
        /// </summary>
        public WithRelease_PatchRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            MakeLatest = WithRelease_PatchRequestBody_make_latest.True;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="WithRelease_PatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WithRelease_PatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithRelease_PatchRequestBody();
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<WithRelease_PatchRequestBody_make_latest>("make_latest", MakeLatest);
