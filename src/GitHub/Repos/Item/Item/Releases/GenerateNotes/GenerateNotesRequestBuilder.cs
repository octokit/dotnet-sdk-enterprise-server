...
namespace GitHub.Repos.Item.Item.Releases.GenerateNotes {
    ...
    public class GenerateNotesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/releases/releases#generate-release-notes-content-for-a-release" />
        /// </summary>
        /// <returns>A <see cref="ReleaseNotesContent"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="GenerateNotesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
