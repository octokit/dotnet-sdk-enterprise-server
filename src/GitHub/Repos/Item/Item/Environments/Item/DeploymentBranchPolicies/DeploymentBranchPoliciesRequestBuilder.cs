...
namespace GitHub.Repos.Item.Item.Environments.Item.DeploymentBranchPolicies
{
    ...
    public partial class DeploymentBranchPoliciesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/deployments/branch-policies#list-deployment-branch-policies" />
        /// </summary>
...
#nullable restore
        ...
        /// <summary>
        /// Creates a deployment branch policy for an environment.OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/deployments/branch-policies#create-a-deployment-branch-policy" />
        /// </summary>
