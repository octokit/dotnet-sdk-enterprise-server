...
namespace GitHub.Repos.Item.Item.Issues.Item.Assignees {
    ...
    public class AssigneesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/issues/assignees#remove-assignees-from-an-issue" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/issues/assignees#add-assignees-to-an-issue" />
        /// </summary>
        /// <returns>A <see cref="Issue"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
