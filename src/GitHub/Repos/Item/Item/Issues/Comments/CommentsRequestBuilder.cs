...
namespace GitHub.Repos.Item.Item.Issues.Comments
{
    ...
    public partial class CommentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Repos.Item.Item.Issues.Comments.Item.WithComment_ItemRequestBuilder this[long position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/issues/comments#list-issue-comments-for-a-repository" />
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.IssueComment>?> GetAsync(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder.CommentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.IssueComment>> GetAsync(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder.CommentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder.CommentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder.CommentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Repos.Item.Item.Issues.Comments.CommentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// You can use the REST API to list comments on issues and pull requests for a repository. Every pull request is an issue, but not every issue is a pull request.By default, issue comments are ordered by ascending ID.This endpoint supports the following custom media types. For more information, see &quot;[Media types](https://docs.github.com/enterprise-server@3.11/rest/using-the-rest-api/getting-started-with-the-rest-api#media-types).&quot;- **`application/vnd.github.raw+json`**: Returns the raw markdown body. Response will include `body`. This is the default if you do not pass any specific media type.- **`application/vnd.github.text+json`**: Returns a text only representation of the markdown body. Response will include `body_text`.- **`application/vnd.github.html+json`**: Returns HTML rendered from the body&apos;s markdown. Response will include `body_html`.- **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
        /// </summary>
        ...
        public partial class CommentsRequestBuilderGetQueryParameters 
        {
            ...
            public global::GitHub.Repos.Item.Item.Issues.Comments.GetDirectionQueryParameterType? Direction { get; set; }
            ...
            [QueryParameter("sort")]
            public global::GitHub.Repos.Item.Item.Issues.Comments.GetSortQueryParameterType? Sort { get; set; }
        }
    }
}
