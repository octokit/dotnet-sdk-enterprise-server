...
namespace GitHub.Repos.Item.Item.Codeowners.Errors
{
    ...
    public partial class ErrorsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// List any syntax errors that are detected in the CODEOWNERSfile.For more information about the correct CODEOWNERS syntax,see &quot;[About code owners](https://docs.github.com/enterprise-server@3.14/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-code-owners).&quot;
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/repos/repos#list-codeowners-errors" />
        /// </summary>
