...
namespace GitHub.Repos.Item.Item.Topics {
    ...
    public class TopicsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/repos/repos#get-all-repository-topics" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/repos/repos#replace-all-repository-topics" />
        /// </summary>
        /// <returns>A <see cref="Topic"/></returns>
