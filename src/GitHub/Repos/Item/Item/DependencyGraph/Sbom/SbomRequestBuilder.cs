...
namespace GitHub.Repos.Item.Item.DependencyGraph.Sbom {
    ...
    public class SbomRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/dependency-graph/sboms#export-a-software-bill-of-materials-sbom-for-a-repository" />
        /// </summary>
        /// <returns>A <see cref="DependencyGraphSpdxSbom"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SbomRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
