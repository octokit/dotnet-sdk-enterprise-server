...
namespace GitHub.Repos.Item.Item.DependencyGraph.Snapshots {
    ...
    public class SnapshotsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/dependency-graph/dependency-submission#create-a-snapshot-of-dependencies-for-a-repository" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SnapshotsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
