...
namespace GitHub.Repos.Item.Item.CheckRuns.Item {
    ...
    public class WithCheck_run_ItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/checks/runs#get-a-check-run" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/checks/runs#update-a-check-run" />
        /// </summary>
        /// <returns>A <see cref="CheckRun"/></returns>
