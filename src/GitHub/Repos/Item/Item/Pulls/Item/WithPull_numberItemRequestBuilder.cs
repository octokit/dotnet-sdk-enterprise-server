...
namespace GitHub.Repos.Item.Item.Pulls.Item {
    ...
    public class WithPull_numberItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new MergeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The requested_reviewers property</summary>
        public Requested_reviewersRequestBuilder Requested_reviewers
        {
            get => new Requested_reviewersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The reviews property</summary>
        public ReviewsRequestBuilder Reviews
        {
            get => new ReviewsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The updateBranch property</summary>
        public UpdateBranchRequestBuilder UpdateBranch
        {
            get => new UpdateBranchRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="WithPull_numberItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/pulls/pulls#get-a-pull-request" />
        /// </summary>
        /// <returns>A <see cref="PullRequest"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="BasicError">When receiving a 404 status code</exception>
        /// <exception cref="BasicError">When receiving a 406 status code</exception>
        /// <exception cref="BasicError">When receiving a 500 status code</exception>
        /// <exception cref="PullRequest503Error">When receiving a 503 status code</exception>
...
#nullable restore
        ...
        public async Task<PullRequest> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                {"406", BasicError.CreateFromDiscriminatorValue},
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/pulls/pulls#update-a-pull-request" />
        /// </summary>
        /// <returns>A <see cref="PullRequest"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WithPull_numberItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
