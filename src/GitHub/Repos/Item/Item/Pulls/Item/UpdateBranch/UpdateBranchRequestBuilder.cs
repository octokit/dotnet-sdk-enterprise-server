...
namespace GitHub.Repos.Item.Item.Pulls.Item.UpdateBranch {
    ...
    public class UpdateBranchRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="UpdateBranchPutResponse"/></returns>
...
#nullable enable
        public async Task<UpdateBranchPutResponse?> PutAsync(UpdateBranchPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UpdateBranchPutResponse> PutAsync(UpdateBranchPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UpdateBranchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
