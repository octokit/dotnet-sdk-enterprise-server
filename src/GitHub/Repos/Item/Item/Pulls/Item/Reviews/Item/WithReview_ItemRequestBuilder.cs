...
namespace GitHub.Repos.Item.Item.Pulls.Item.Reviews.Item {
    ...
    public class WithReview_ItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/pulls/reviews#delete-a-pending-review-for-a-pull-request" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/pulls/reviews#get-a-review-for-a-pull-request" />
        /// </summary>
        /// <returns>A <see cref="PullRequestReview"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/pulls/reviews#update-a-review-for-a-pull-request" />
        /// </summary>
        /// <returns>A <see cref="PullRequestReview"/></returns>
