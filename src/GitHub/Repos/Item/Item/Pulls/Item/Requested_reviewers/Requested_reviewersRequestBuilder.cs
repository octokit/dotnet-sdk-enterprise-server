...
namespace GitHub.Repos.Item.Item.Pulls.Item.Requested_reviewers {
    ...
    public class Requested_reviewersRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/pulls/review-requests#remove-requested-reviewers-from-a-pull-request" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/pulls/review-requests#get-all-requested-reviewers-for-a-pull-request" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/pulls/review-requests#request-reviewers-for-a-pull-request" />
        /// </summary>
        /// <returns>A <see cref="PullRequestSimple"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
