...
namespace GitHub.Repos.Item.Item.Contents.Item {
    ...
    public class WithPathItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/repos/contents#delete-a-file" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/repos/contents#get-repository-content" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/repos/contents#create-or-update-file-contents" />
        /// </summary>
        /// <returns>A <see cref="FileCommit"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
