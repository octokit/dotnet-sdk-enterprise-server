...
#nullable restore
        ...
        public global::GitHub.Models.WebhookConfig Config { get; set; }
#endif
        /// <summary>Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
