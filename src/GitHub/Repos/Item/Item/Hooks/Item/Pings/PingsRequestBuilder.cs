...
namespace GitHub.Repos.Item.Item.Hooks.Item.Pings
{
    ...
    public partial class PingsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// This will trigger a [ping event](https://docs.github.com/enterprise-server@3.11/webhooks/#ping-event) to be sent to the hook.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/repos/webhooks#ping-a-repository-webhook" />
        /// </summary>
