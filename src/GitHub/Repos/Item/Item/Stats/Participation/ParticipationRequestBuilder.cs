...
namespace GitHub.Repos.Item.Item.Stats.Participation {
    ...
    public class ParticipationRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/metrics/statistics#get-the-weekly-commit-count" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ParticipationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
