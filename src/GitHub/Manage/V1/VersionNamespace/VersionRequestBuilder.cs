...
namespace GitHub.Manage.V1.VersionNamespace
{
    ...
    public partial class VersionRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the GitHub Enterprise Server release versions that are currently installed on all available nodes. For more information, see &quot;[GitHub Enterprise Server releases](https://docs.github.com/enterprise-server@3.11/admin/all-releases).&quot;
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/enterprise-admin/manage-ghes#get-all-ghes-release-versions-for-all-nodes" />
        /// </summary>
