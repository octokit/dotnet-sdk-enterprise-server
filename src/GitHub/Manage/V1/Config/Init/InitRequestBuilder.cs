...
namespace GitHub.Manage.V1.Config.Init {
    ...
    /// </summary>
    public class InitRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="InitRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="InitRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public InitRequestBuilder WithUrl(string rawUrl)
        {
