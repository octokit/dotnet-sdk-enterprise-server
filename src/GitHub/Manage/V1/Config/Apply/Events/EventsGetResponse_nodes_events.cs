...
namespace GitHub.Manage.V1.Config.Apply.Events {
    ...
    public class EventsGetResponse_nodes_events : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="EventsGetResponse_nodes_events"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="EventsGetResponse_nodes_events"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static EventsGetResponse_nodes_events CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new EventsGetResponse_nodes_events();
        }
        /// <summary>
