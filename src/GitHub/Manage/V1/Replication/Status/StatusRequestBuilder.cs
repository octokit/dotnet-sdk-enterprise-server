...
namespace GitHub.Manage.V1.Replication.Status {
    ...
    public class StatusRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/enterprise-admin/manage-ghes#get-the-status-of-services-running-on-all-replica-nodes" />
        /// </summary>
...
#nullable enable
        public async Task<GhesReplicationStatus?> GetAsync(Action<RequestConfiguration<StatusRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<GhesReplicationStatus> GetAsync(Action<RequestConfiguration<StatusRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<GhesReplicationStatus>(requestInfo, GhesReplicationStatus.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets the status of all services running on each replica node.This endpoint may take several seconds to reply.
        /// </summary>
