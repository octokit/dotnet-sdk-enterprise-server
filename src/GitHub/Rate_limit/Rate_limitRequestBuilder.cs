...
namespace GitHub.Rate_limit {
    ...
    public class Rate_limitRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/rate-limit/rate-limit#get-rate-limit-status-for-the-authenticated-user" />
        /// </summary>
