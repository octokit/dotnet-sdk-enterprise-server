...
namespace GitHub.User.Packages.Item.Item.Versions
{
    ...
    public partial class VersionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/packages/packages#list-package-versions-for-a-package-owned-by-the-authenticated-user" />
        /// </summary>
