...
namespace GitHub.User.Packages.Item.Item.Versions.Item.Restore
{
    ...
    public partial class RestoreRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/packages/packages#restore-a-package-version-for-the-authenticated-user" />
        /// </summary>
