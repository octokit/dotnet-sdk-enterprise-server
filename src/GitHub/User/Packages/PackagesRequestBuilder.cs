...
namespace GitHub.User.Packages
{
    ...
    public partial class PackagesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/packages/packages#list-packages-for-the-authenticated-users-namespace" />
        /// </summary>
