...
namespace GitHub.User.Public_emails {
    ...
    public class Public_emailsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/users/emails#list-public-email-addresses-for-the-authenticated-user" />
        /// </summary>
...
#nullable enable
        public async Task<List<Email>?> GetAsync(Action<RequestConfiguration<Public_emailsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<Email>> GetAsync(Action<RequestConfiguration<Public_emailsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
