...
namespace GitHub.User.Starred {
    ...
    public class StarredRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/activity/starring#list-repositories-starred-by-the-authenticated-user" />
        /// </summary>
