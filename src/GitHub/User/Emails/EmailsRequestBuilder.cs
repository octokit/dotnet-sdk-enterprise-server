...
namespace GitHub.User.Emails {
    ...
    public class EmailsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/users/emails#delete-an-email-address-for-the-authenticated-user" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/users/emails#list-email-addresses-for-the-authenticated-user" />
        /// </summary>
...
#nullable restore
        ...
        /// <summary>
        /// OAuth app tokens and personal access tokens (classic) need the `user` scope to use this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/users/emails#add-an-email-address-for-the-authenticated-user" />
        /// </summary>
        /// <returns>A List&lt;Email&gt;</returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
