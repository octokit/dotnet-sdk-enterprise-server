...
namespace GitHub.User.Memberships.Orgs
{
    ...
    public partial class OrgsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/members#list-organization-memberships-for-the-authenticated-user" />
        /// </summary>
