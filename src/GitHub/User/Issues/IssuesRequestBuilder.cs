...
namespace GitHub.User.Issues {
    ...
    public class IssuesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/issues/issues#list-user-account-issues-assigned-to-the-authenticated-user" />
        /// </summary>
