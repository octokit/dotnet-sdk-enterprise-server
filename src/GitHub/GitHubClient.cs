...
namespace GitHub {
    ...
    public class GitHubClient : BaseRequestBuilder 
    {
        ...
        public EnterpriseRequestBuilder Enterprise
        {
            get => new EnterpriseRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ManageRequestBuilder Manage
        {
            get => new ManageRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new SetupRequestBuilder(PathParameters, RequestAdapter);
        }
