...
namespace GitHub.App.Hook.Deliveries
{
    ...
    public partial class DeliveriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Returns a list of webhook deliveries for the webhook configured for a GitHub App.You must use a [JWT](https://docs.github.com/enterprise-server@3.13/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/apps/webhooks#list-deliveries-for-an-app-webhook" />
        /// </summary>
