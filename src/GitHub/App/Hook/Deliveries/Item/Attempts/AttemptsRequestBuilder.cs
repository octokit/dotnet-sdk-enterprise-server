...
namespace GitHub.App.Hook.Deliveries.Item.Attempts
{
    ...
    public partial class AttemptsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Redeliver a delivery for the webhook configured for a GitHub App.You must use a [JWT](https://docs.github.com/enterprise-server@3.13/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/apps/webhooks#redeliver-a-delivery-for-an-app-webhook" />
        /// </summary>
