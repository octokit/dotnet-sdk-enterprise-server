...
namespace GitHub.App.Hook.Deliveries.Item
{
    ...
    public partial class WithDelivery_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Returns a delivery for the webhook configured for a GitHub App.You must use a [JWT](https://docs.github.com/enterprise-server@3.11/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/apps/webhooks#get-a-delivery-for-an-app-webhook" />
        /// </summary>
