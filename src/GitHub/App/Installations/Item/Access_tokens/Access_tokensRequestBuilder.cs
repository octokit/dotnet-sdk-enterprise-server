...
namespace GitHub.App.Installations.Item.Access_tokens {
    ...
    public class Access_tokensRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/apps/apps#create-an-installation-access-token-for-an-app" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Access_tokensRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
