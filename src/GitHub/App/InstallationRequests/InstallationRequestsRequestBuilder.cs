...
namespace GitHub.App.InstallationRequests {
    ...
    public class InstallationRequestsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/apps/apps#list-installation-requests-for-the-authenticated-app" />
        /// </summary>
        /// <returns>A List&lt;IntegrationInstallationRequest&gt;</returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="InstallationRequestsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
