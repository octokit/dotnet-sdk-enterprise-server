...
namespace GitHub.Orgs.Item.OrganizationRoles.Item
{
    ...
    public partial class WithRole_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/organization-roles#delete-a-custom-organization-role" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/organization-roles#get-an-organization-role" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/organization-roles#update-a-custom-organization-role" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Models.OrganizationRole"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.OrganizationRole?> PatchAsync(global::GitHub.Models.OrganizationCustomOrganizationRoleUpdateSchema body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.OrganizationRole> PatchAsync(global::GitHub.Models.OrganizationCustomOrganizationRoleUpdateSchema body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Models.OrganizationCustomOrganizationRoleUpdateSchema body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Models.OrganizationCustomOrganizationRoleUpdateSchema body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
