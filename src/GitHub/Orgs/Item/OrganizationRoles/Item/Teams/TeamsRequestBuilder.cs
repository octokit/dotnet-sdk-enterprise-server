...
namespace GitHub.Orgs.Item.OrganizationRoles.Item.Teams
{
    ...
    public partial class TeamsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/organization-roles#list-teams-that-are-assigned-to-an-organization-role" />
        /// </summary>
