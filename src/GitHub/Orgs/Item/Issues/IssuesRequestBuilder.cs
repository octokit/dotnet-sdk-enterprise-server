...
namespace GitHub.Orgs.Item.Issues
{
    ...
    public partial class IssuesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/issues/issues#list-organization-issues-assigned-to-the-authenticated-user" />
        /// </summary>
