...
namespace GitHub.Orgs.Item.Migrations
{
    ...
    public partial class MigrationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Orgs.Item.Migrations.Item.WithMigration_ItemRequestBuilder this[int position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/migrations/orgs#list-organization-migrations" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.Models.Migration&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::GitHub.Models.Migration>?> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder.MigrationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.Migration>> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder.MigrationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.Models.Migration>(requestInfo, global::GitHub.Models.Migration.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/migrations/orgs#start-an-organization-migration" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.Migration?> PostAsync(global::GitHub.Orgs.Item.Migrations.MigrationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.Migration> PostAsync(global::GitHub.Orgs.Item.Migrations.MigrationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder.MigrationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder.MigrationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHub.Orgs.Item.Migrations.MigrationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHub.Orgs.Item.Migrations.MigrationsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Migrations.MigrationsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists the most recent migrations, including both exports (which can be started through the REST API) and imports (which cannot be started using the REST API).A list of `repositories` is only returned for export migrations.
        /// </summary>
...
#nullable enable
            ...
            public global::GitHub.Orgs.Item.Migrations.GetExcludeQueryParameterType[]? Exclude { get; set; }
#nullable restore
#else
            [QueryParameter("exclude")]
            public global::GitHub.Orgs.Item.Migrations.GetExcludeQueryParameterType[] Exclude { get; set; }
