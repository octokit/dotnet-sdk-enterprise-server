...
namespace GitHub.Orgs.Item.Migrations.Item.Repos.Item.Lock
{
    ...
    public partial class LockRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Unlocks a repository that was locked for migration. You should unlock each migrated repository and [delete them](https://docs.github.com/enterprise-server@3.14/rest/repos/repos#delete-a-repository) when the migration is complete and you no longer need the source data.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/migrations/orgs#unlock-an-organization-repository" />
        /// </summary>
