...
namespace GitHub.Orgs.Item.RepositoryFineGrainedPermissions {
    ...
    /// </summary>
    public class RepositoryFineGrainedPermissionsRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="RepositoryFineGrainedPermissionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/orgs/custom-roles#list-repository-fine-grained-permissions-for-an-organization" />
        /// </summary>
        /// <returns>A List&lt;RepositoryFineGrainedPermission&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<RepositoryFineGrainedPermission>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<RepositoryFineGrainedPermission>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<RepositoryFineGrainedPermission>(requestInfo, RepositoryFineGrainedPermission.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="RepositoryFineGrainedPermissionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public RepositoryFineGrainedPermissionsRequestBuilder WithUrl(string rawUrl)
        {
            return new RepositoryFineGrainedPermissionsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
