...
#nullable restore
        ...
        public global::GitHub.Orgs.Item.Hooks.HooksPostRequestBody_config Config { get; set; }
#endif
        /// <summary>Determines what [events](https://docs.github.com/enterprise-server@3.14/webhooks/event-payloads) the hook is triggered for. Set to `[&quot;*&quot;]` to receive all possible events.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
