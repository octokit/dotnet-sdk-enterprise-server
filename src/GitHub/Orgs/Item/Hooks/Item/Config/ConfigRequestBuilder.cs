...
namespace GitHub.Orgs.Item.Hooks.Item.Config
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/orgs/webhooks#get-a-webhook-configuration-for-an-organization" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/orgs/webhooks#update-a-webhook-configuration-for-an-organization" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Models.WebhookConfig"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Models.WebhookConfig?> PatchAsync(global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Models.WebhookConfig> PatchAsync(global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
