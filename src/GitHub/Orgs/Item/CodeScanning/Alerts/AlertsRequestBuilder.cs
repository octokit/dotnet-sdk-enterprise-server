...
namespace GitHub.Orgs.Item.CodeScanning.Alerts
{
    ...
    public partial class AlertsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/code-scanning/code-scanning#list-code-scanning-alerts-for-an-organization" />
        /// </summary>
