...
namespace GitHub.Orgs.Item.Actions.Secrets.Item
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get an organization public key](https://docs.github.com/enterprise-server@3.10/rest/actions/secrets#get-an-organization-public-key) endpoint.</summary>
...
#nullable restore
        ...
        public global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody_visibility? Visibility { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "visibility", n => { Visibility = n.GetEnumValue<global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody_visibility>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.Orgs.Item.Actions.Secrets.Item.WithSecret_namePutRequestBody_visibility>("visibility", Visibility);
