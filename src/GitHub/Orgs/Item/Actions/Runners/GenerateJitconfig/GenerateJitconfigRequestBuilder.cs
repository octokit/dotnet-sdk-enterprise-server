...
namespace GitHub.Orgs.Item.Actions.Runners.GenerateJitconfig {
    ...
    public class GenerateJitconfigRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/actions/self-hosted-runners#create-configuration-for-a-just-in-time-runner-for-an-organization" />
        /// </summary>
