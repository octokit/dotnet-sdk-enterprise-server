...
namespace GitHub.Orgs.Item.Actions.Runners.RemoveToken {
    ...
    public class RemoveTokenRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.10/rest/actions/self-hosted-runners#create-a-remove-token-for-an-organization" />
        /// </summary>
