...
namespace GitHub.Orgs.Item.Actions.Runners.RemoveToken
{
    ...
    public partial class RemoveTokenRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/actions/self-hosted-runners#create-a-remove-token-for-an-organization" />
        /// </summary>
