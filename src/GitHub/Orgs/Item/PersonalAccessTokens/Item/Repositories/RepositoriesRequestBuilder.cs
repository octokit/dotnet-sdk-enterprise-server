...
namespace GitHub.Orgs.Item.PersonalAccessTokens.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/orgs/personal-access-tokens#list-repositories-a-fine-grained-personal-access-token-has-access-to" />
        /// </summary>
