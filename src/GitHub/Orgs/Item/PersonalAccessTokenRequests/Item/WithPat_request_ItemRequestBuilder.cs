...
namespace GitHub.Orgs.Item.PersonalAccessTokenRequests.Item
{
    ...
    public partial class WithPat_request_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/personal-access-tokens#review-a-request-to-access-organization-resources-with-a-fine-grained-personal-access-token" />
        /// </summary>
