...
namespace GitHub.Orgs.Item.ExternalGroups {
    ...
    public class ExternalGroupsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/teams/external-groups#list-external-groups-in-an-organization" />
        /// </summary>
...
#nullable enable
        public async Task<GitHub.Models.ExternalGroups?> GetAsync(Action<RequestConfiguration<ExternalGroupsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<GitHub.Models.ExternalGroups> GetAsync(Action<RequestConfiguration<ExternalGroupsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ExternalGroupsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ExternalGroupsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// Lists external groups available in an organization. You can query the groups using the `display_name` parameter, only groups with a `group_name` containing the text provided in the `display_name` parameter will be returned.  You can also limit your page results using the `per_page` parameter. GitHub Enterprise Server generates a url-encoded `page` token using a cursor value for where the next page begins. For more information on cursor pagination, see &quot;[Offset and Cursor Pagination explained](https://dev.to/jackmarchant/offset-and-cursor-pagination-explained-b89).&quot;You can manage team membership with your identity provider using Enterprise Managed Users for GitHub Enterprise Cloud. For more information, see &quot;[GitHub&apos;s products](https://docs.github.com/enterprise-server@3.11/github/getting-started-with-github/githubs-products)&quot; in the GitHub Help documentation.
        /// </summary>
        public class ExternalGroupsRequestBuilderGetQueryParameters 
        {
