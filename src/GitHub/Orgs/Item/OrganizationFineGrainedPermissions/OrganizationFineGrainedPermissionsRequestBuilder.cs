...
namespace GitHub.Orgs.Item.OrganizationFineGrainedPermissions {
    ...
    public class OrganizationFineGrainedPermissionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/orgs/organization-roles#list-organization-fine-grained-permissions-for-an-organization" />
        /// </summary>
