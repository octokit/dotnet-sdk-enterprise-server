...
namespace GitHub.Orgs.Item.Docker.Conflicts
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Docker.Conflicts.ConflictsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/packages/packages#get-list-of-conflicting-packages-during-docker-migration-for-organization" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Docker.Conflicts.ConflictsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Docker.Conflicts.ConflictsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Docker.Conflicts.ConflictsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
