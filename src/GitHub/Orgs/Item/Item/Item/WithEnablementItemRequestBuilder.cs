...
namespace GitHub.Orgs.Item.Item.Item
{
    ...
    public partial class WithEnablementItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/orgs#enable-or-disable-a-security-feature-for-an-organization" />
        /// </summary>
