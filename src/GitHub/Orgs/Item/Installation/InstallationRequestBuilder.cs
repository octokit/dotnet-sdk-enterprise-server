...
namespace GitHub.Orgs.Item.Installation
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Installation.InstallationRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <summary>
        /// Enables an authenticated GitHub App to find the organization&apos;s installation information.You must use a [JWT](https://docs.github.com/enterprise-server@3.13/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/apps/apps#get-an-organization-installation-for-the-authenticated-app" />
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Installation.InstallationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Installation.InstallationRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Installation.InstallationRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
