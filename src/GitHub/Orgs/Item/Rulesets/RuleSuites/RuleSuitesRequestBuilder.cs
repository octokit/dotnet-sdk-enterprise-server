...
namespace GitHub.Orgs.Item.Rulesets.RuleSuites
{
    ...
    public partial class RuleSuitesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="position">The unique identifier of the rule suite result.To get this ID, you can use [GET /repos/{owner}/{repo}/rulesets/rule-suites](https://docs.github.com/enterprise-server@3.14/rest/repos/rule-suites#list-repository-rule-suites)for repositories and [GET /orgs/{org}/rulesets/rule-suites](https://docs.github.com/enterprise-server@3.14/rest/orgs/rule-suites#list-organization-rule-suites)for organizations.</param>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder"/></returns>
        public global::GitHub.Orgs.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("rule_suite_id", position);
                return new global::GitHub.Orgs.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/orgs/rule-suites#list-organization-rule-suites" />
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.RuleSuites>?> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.RuleSuites>> GetAsync(Action<RequestConfiguration<global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Orgs.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists suites of rule evaluations at the organization level.For more information, see &quot;[Managing rulesets for repositories in your organization](https://docs.github.com/enterprise-server@3.14/organizations/managing-organization-settings/managing-rulesets-for-repositories-in-your-organization#viewing-insights-for-rulesets).&quot;
        /// </summary>
...
#nullable restore
            ...
            public global::GitHub.Orgs.Item.Rulesets.RuleSuites.GetTime_periodQueryParameterType? TimePeriod { get; set; }
        }
    }
}
