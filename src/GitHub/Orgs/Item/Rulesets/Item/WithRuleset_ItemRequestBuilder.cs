...
namespace GitHub.Orgs.Item.Rulesets.Item {
    ...
    public class WithRuleset_ItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/rules#delete-an-organization-repository-ruleset" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/rules#get-an-organization-repository-ruleset" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<RepositoryRuleset?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<RepositoryRuleset> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/orgs/rules#update-an-organization-repository-ruleset" />
        /// </summary>
        /// <returns>A <see cref="RepositoryRuleset"/></returns>
