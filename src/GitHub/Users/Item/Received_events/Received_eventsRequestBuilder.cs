...
namespace GitHub.Users.Item.Received_events
{
    ...
    public partial class Received_eventsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Users.Item.Received_events.Public.PublicRequestBuilder Public
        {
            get => new global::GitHub.Users.Item.Received_events.Public.PublicRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/activity/events#list-events-received-by-the-authenticated-user" />
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.Event>?> GetAsync(Action<RequestConfiguration<global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder.Received_eventsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.Event>> GetAsync(Action<RequestConfiguration<global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder.Received_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder.Received_eventsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder.Received_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Users.Item.Received_events.Received_eventsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// These are events that you&apos;ve received by watching repositories and following users. If you are authenticated as thegiven user, you will see private events. Otherwise, you&apos;ll only see public events.&gt; [!NOTE]&gt; This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
        /// </summary>
