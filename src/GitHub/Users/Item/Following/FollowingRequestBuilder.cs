...
namespace GitHub.Users.Item.Following {
    ...
    public class FollowingRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WithTarget_userItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.11/rest/users/followers#list-the-people-a-user-follows" />
        /// </summary>
