...
namespace GitHub.Users.Item.Packages.Item.Item.Versions {
    ...
    public class VersionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.13/rest/packages/packages#list-package-versions-for-a-package-owned-by-a-user" />
        /// </summary>
