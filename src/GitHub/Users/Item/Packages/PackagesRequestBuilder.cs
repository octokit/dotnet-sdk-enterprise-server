...
namespace GitHub.Users.Item.Packages
{
    ...
    public partial class PackagesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="global::GitHub.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder"/></returns>
        public global::GitHub.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("package_type", position);
                return new global::GitHub.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Users.Item.Packages.PackagesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/packages/packages#list-packages-for-a-user" />
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.Models.Package>?> GetAsync(Action<RequestConfiguration<global::GitHub.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Models.Package>> GetAsync(Action<RequestConfiguration<global::GitHub.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Users.Item.Packages.PackagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Users.Item.Packages.PackagesRequestBuilder WithUrl(string rawUrl)
        {
        ...
        public partial class PackagesRequestBuilderGetQueryParameters 
        {
            ...
            public global::GitHub.Users.Item.Packages.GetPackage_typeQueryParameterType? PackageType { get; set; }
