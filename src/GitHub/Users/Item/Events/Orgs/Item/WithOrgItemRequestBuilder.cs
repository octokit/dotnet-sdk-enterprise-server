...
namespace GitHub.Users.Item.Events.Orgs.Item
{
    ...
    public partial class WithOrgItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.14/rest/activity/events#list-organization-events-for-the-authenticated-user" />
        /// </summary>
