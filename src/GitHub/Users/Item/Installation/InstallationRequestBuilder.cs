...
namespace GitHub.Users.Item.Installation
{
    ...
    public partial class InstallationRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Enables an authenticated GitHub App to find the user’s installation information.You must use a [JWT](https://docs.github.com/enterprise-server@3.12/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
        /// API method documentation <see href="https://docs.github.com/enterprise-server@3.12/rest/apps/apps#get-a-user-installation-for-the-authenticated-app" />
        /// </summary>
